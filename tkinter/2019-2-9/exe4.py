...
x0, y0, x1, y1 = 0,30,0,180
line = canvas.create_line(x0, y0, x1, y1)
oval = canvas.create_oval(x0+50, y0+50, x1+200, y1+50, fill='red') #左上角顶点坐标与右下角顶点坐标
arc  = canvas.create_arc(x0+30+250, y0+250, x1+300+250, y1+90+250, start = 10, extent = 100, fill = 'yellow')
rect = canvas.create_rectangle(600,100,700,200)  #前面2个参数分别对应顶点坐标，后面两个参数700-600=100 x坐标长度，200-100=100y坐标长度
poly = canvas.create_polygon(400, 220, 220, 310, 230, 190) #分别对应三个顶点坐标(400,220),(220,310),(230,190)
